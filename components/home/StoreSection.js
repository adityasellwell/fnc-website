 ...
 * Renders an active store card with an interactive map & geolocation,
 * next to a sidebar of coming-soon locations.
 */
    ...
    <Section background="warmwhite">
      <div className="max-w-2xl mb-10">
        ...
        <h2 className="font-display text-section-heading font-bold text-charcoal">
          One store live today, more on the way.
        </h2>
      </div>

      <div className="grid lg:grid-cols-2 gap-8 items-start">
        {/* Left Column: Client-Side Interactive Map & Store Card */}
        <Reveal>
          <StoreLocatorInteractive store={store} />
        </Reveal>

        {/* Right Column: Coming Soon list */}
